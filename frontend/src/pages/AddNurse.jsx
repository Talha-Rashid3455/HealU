...
const AddNurse = () => {
    ...
    return (
        <div className="bg-gradient-to-r from-[#0098B9] to-[#003844]" >
        <div className="flex flex-row  w-screen h-screen p-24 mb-24  h-full overflow-y-auto">
           
            <form className="ml-48 mt-24 w-96 mb-24 flex flex-col justify-start">
